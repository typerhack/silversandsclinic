<div class="reservation_btn flex_container_justify_center">
    <a href="" class="reservation_btn_link font_base_regular">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="reservation_btn_icon">
...
<?php echo "this is the component"; ?>